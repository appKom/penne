const HowToApply = () => (
  <div className='mx-40 my-4'>
    <h1 className='my-6 text-4xl'>Hvordan søke om støtte?</h1>
    <p>
      ...
      dersom det søkes om mellom 10 000 kr og 100 000 kr. <br></br>
    ...
    <p>Søknader sendes til: fond@online.ntnu.no</p>
  </div>
);
